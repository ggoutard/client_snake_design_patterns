...
public class SnakeGame extends Game {
    ...
    private SnakeGame(PanelSnakeGame panel,String fileName, TypeSnake joueur1, TypeSnake joueur2) 
    {
        super(0);
    ...
    public static SnakeGame buildGame(PanelSnakeGame panel,String fileName, TypeSnake joueur1, TypeSnake joueur2) 
    {
        if(SnakeGame.Uniqueinstance == null)
        {
            SnakeGame.Uniqueinstance = new SnakeGame(panel,fileName,joueur1,joueur2);
