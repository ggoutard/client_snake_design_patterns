...
public class ClientSnake extends Client {
    ...
    private static class ThreadInput implements Runnable, Observer {
        ...
        public void updatePanel(String json)
        {
        	PanelBuilder panelBuilder = PanelBuilder.fromJson(json);
        	this.controller.update(panelBuilder.getFeaturesSnakes(), panelBuilder.getFeaturesItems());
        }
