package tp1progreseau.tp1progreseau.accueil.copy2;
    ...
    public void Launch() {
        ...
        if (players.equals("Un joueur")) {
            switch (mapSize) {
                case "Petite":
                    if (walls.equals("Avec murs")) {
                        path = "Projet/layouts/small.lay";
                    } else {
                        path = "Projet/layouts/smallNoWall.lay";
                    }
                    break;
                case "Grande":
                    if (walls.equals("Avec murs")) {
                        path = "Projet/layouts/alone.lay";
                    } else {
                        path = "Projet/layouts/aloneNoWall.lay";
            ...
            switch (mapSize) {
                case "Petite":
                    if (walls.equals("Avec murs")) {
                        path = "Projet/layouts/smallArena.lay";
                    } else {
                        path = "Projet/layouts/smallArenaNoWall.lay";                    }
                    break;

                case "Grande":
                    if (walls.equals("Avec murs")) 
                    {
                        path = "Projet/layouts/arena.lay";
                    } 
                    else {
                        path = "Projet/layouts/arenaNoWall.lay";
                    }   
                    break;               
                }
            }
